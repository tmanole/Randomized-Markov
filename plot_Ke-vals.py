...
p_dtr = np.load("matrices/Ke_vals/power_dtr.npy")/reps
p_umi = np.load("matrices/Ke_vals/power_umi.npy")/reps
p_emi = np.load("matrices/Ke_vals/power_emi.npy")/reps
p_rmi = np.load("matrices/Ke_vals/power_rmi.npy")/reps
...
#    plt.savefig("plots/Ke_val_" + key + ".pdf")
#    plt.clf()
...
for ax, im in zip(grid, [p_dtr,p_emi,p_umi,p_rmi]):
    ...
    im = ax.imshow(im,cmap=cmap2,interpolation='nearest')   
...
plt.savefig("plots/Ke_val_all.pdf", bbox_inches = 'tight',pad_inches = 0)
plt.clf()
...
plt.savefig("plots/Ke_val_scaled.pdf", bbox_inches = 'tight',pad_inches = 0)
plt.clf()
